...
input_folder = "/home/abhijit/nas_drive/Abhijit/Shubham/ejnmmi-dpnn/Codes/Checkpoints/ROOT_FOR_TESTING_1"
...
tpc.calculate_and_store_test_predictions(input_folder, op_folder,"PXNET_GAP_SIG_SET1.2_",
                                    net=network,model_arg_dict={},X=X,suffix="test_predns")
h5list = tpc._get_h5_file_list_to_combine(op_folder,["PXNET_GAP_SIG_SET1.2_"],1)
...
tpc.combine_predictions_from_h5_file(op_folder, combined_op_folder,
                                    model_name="PXNET_GAP_SIG_SET1.2_", suffix="_predictions",match_terms=[], level=1)
