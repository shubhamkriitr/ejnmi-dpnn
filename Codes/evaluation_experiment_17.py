...
#%%Select the network
from PretrainingPXNetFirstHalf import ProjectionNetFirstHalf as model_class

name = "EXP_17_PXNET_CMP"
#%%Fetch data
...
#pc.pick_models(model_dir,file_keys,max_fold)
wait = input('wait')
...
root_dir = os.getcwd()+os.sep+"Checkpoints"+os.sep+"Selected_2018-02-13-100348"
