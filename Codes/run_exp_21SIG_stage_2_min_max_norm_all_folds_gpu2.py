...
for lr in lrs:
    ...
    for fold in range(1,max_fold+1):
        ...
        model_name = "EXP_21SIG_STAGEII_"+set_id+"fold_"+str(fold)+"_"
        ...
        X_pd , Y_pd = data.get_parkinson_TF_data(ranges=r_pd)
        X_val_pd, Y_val_pd = data.get_parkinson_TF_data(ranges=s_pd)
